...
HD_PWD='C:/Users/TARIK/Desktop/HDL/ip_catalog/func2.runs/func2_bd_func2_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log func2_bd_func2_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source func2_bd_func2_1_0.tcl
