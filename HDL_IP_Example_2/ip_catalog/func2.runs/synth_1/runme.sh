...
HD_PWD='C:/Users/TARIK/Desktop/HDL/ip_catalog/func2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log func2_bd_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source func2_bd_wrapper.tcl
