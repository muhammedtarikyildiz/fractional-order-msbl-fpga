...
begin
  ...
  clk_net <= clk_1;
  ce_net <= ce_1;
  multiply3 : entity xil_defaultlib.sysgen_mult_a922c05ee8 
  port map (
    clr => '0',
    a => ud2_q_net,
    b => constant3_op_net,
  ...
  multiply4 : entity xil_defaultlib.sysgen_mult_30e0b845fa 
  port map (
    clr => '0',
    a => ud1_q_net,
    b => constant2_op_net,
  ...
  multiply1 : entity xil_defaultlib.sysgen_mult_30e0b845fa 
  port map (
    clr => '0',
