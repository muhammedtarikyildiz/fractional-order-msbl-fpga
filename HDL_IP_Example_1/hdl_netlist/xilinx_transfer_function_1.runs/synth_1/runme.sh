...
HD_PWD='C:/Users/TARIK/Desktop/HDL_IP_Example_1/hdl_netlist/xilinx_transfer_function_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log xilinx_transfer_function_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source xilinx_transfer_function_1.tcl
