...
HD_PWD='C:/Users/TARIK/Desktop/HDL_IP_Example_1/ip_catalog/func1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log func1_bd_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source func1_bd_wrapper.tcl
