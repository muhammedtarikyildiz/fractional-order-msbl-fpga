...
HD_PWD='C:/Users/TARIK/Desktop/HDL_IP_Example_1/ip_catalog/func1.runs/func1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log func1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source func1_0.tcl
