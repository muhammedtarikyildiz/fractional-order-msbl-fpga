...
HD_PWD='C:/Users/TARIK/Desktop/HDL_Example1/hdl_netlist/xilinx_transfer_function_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log xilinx_transfer_function_1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source xilinx_transfer_function_1.tcl -notrace
