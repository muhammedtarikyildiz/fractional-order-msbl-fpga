...
HD_PWD='C:/Users/TARIK/Desktop/HDL/hdl_netlist/xilinx_transfer_function.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log xilinx_transfer_function.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source xilinx_transfer_function.tcl -notrace
