...
HD_PWD='C:/Users/TARIK/Desktop/HDL/hdl_netlist/xilinx_transfer_function.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log xilinx_transfer_function.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source xilinx_transfer_function.tcl
